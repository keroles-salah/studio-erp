...
async function main() {
  ...
  const servicesData = [
    { name: 'Wedding Photography', description: 'Full wedding day photography coverage with 2 photographers', category: 'Photography', basePrice: 5000, cost: 500, taxRate: 0, status: 'ACTIVE' },
    { name: 'Wedding Videography', description: 'Cinematic wedding film + highlight reel', category: 'Videography', basePrice: 7000, cost: 800, taxRate: 0, status: 'ACTIVE' },
    { name: 'Engagement Photography', description: 'Pre-wedding engagement photo session', category: 'Photography', basePrice: 2000, cost: 200, taxRate: 0, status: 'ACTIVE' },
    { name: 'Studio Photography', description: 'In-studio portrait session (1 hour)', category: 'Photography', basePrice: 800, cost: 100, taxRate: 0, status: 'ACTIVE' },
    { name: 'Event Photography', description: 'Corporate or private event photography', category: 'Photography', basePrice: 2000, cost: 200, taxRate: 0, status: 'ACTIVE' },
    { name: 'Event Videography', description: 'Corporate or private event video coverage', category: 'Videography', basePrice: 3000, cost: 300, taxRate: 0, status: 'ACTIVE' },
    { name: 'Audio / Sound System', description: 'Professional sound system setup and operation', category: 'Audio', basePrice: 1500, cost: 200, taxRate: 0, status: 'ACTIVE' },
    { name: 'Lighting Setup', description: 'Professional event lighting design and setup', category: 'Lighting', basePrice: 1200, cost: 150, taxRate: 0, status: 'ACTIVE' },
    { name: 'Equipment Rental', description: 'Camera, lens, and gear rental (per day)', category: 'Rental', basePrice: 500, cost: 50, taxRate: 0, status: 'ACTIVE' },
    { name: 'Video Editing', description: 'Professional post-production video editing', category: 'Editing', basePrice: 1500, cost: 100, taxRate: 0, status: 'ACTIVE' },
    { name: 'Photo Retouching', description: 'Professional photo editing and retouching (per 50 photos)', category: 'Editing', basePrice: 600, cost: 50, taxRate: 0, status: 'ACTIVE' },
    { name: 'Drone Coverage', description: 'Aerial photography and videography with drone', category: 'Videography', basePrice: 2500, cost: 300, taxRate: 0, status: 'ACTIVE' },
    { name: 'Live Streaming', description: 'Live event streaming to social media platforms', category: 'Videography', basePrice: 3500, cost: 400, taxRate: 0, status: 'ACTIVE' },
    { name: 'Print Services', description: 'Photo printing and album creation', category: 'Print', basePrice: 1000, cost: 200, taxRate: 0, status: 'ACTIVE' },
    { name: 'Engagement Session', description: 'Pre-wedding engagement photo session (2 hours)', category: 'Photography', basePrice: 1500, cost: 200, taxRate: 0, status: 'ACTIVE' },
    { name: 'Drone Aerial Coverage', description: 'Aerial drone videography for events (per hour)', category: 'Videography', basePrice: 900, cost: 150, taxRate: 0, status: 'ACTIVE' },
  ];
